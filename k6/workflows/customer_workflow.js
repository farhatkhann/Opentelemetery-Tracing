...
export function setup() {
    ...
    const addressRes = http.post(`${SERVICES.customer}/address`, addressPayload, params);
...
export default function (data) {
    ...
    const profileRes = http.get(`${SERVICES.customer}/profile`, params);
    check(profileRes, { "profile 200": (r) => r.status === 200 });

    const shoppingRes = http.get(`${SERVICES.customer}/shoping-details`, params);
